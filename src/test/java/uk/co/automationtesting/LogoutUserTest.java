...
public class LogoutUserTest extends Hooks {

	public LogoutUserTest() throws IOException {
		super();
	...
	public void logoutUserTest() throws IOException {
		...
		waitForElementVisible(home.getLoggedInName(), Duration.ofMillis(7000));
		try {
			Assert.assertEquals(home.getLoggedInName().getText(), "Logged in as Apple1Apple1");
		...
		ExtentManager.pass("Logout button clicked");
